...
namespace Library.API.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public IActionResult PartiallyUpdateBookForAuthor(Guid authorId, Guid id,
            [FromBody] JsonPatchDocument<BookForUpdateDto> pathDoc)
        {
            if (pathDoc == null)
                return BadRequest();
            ...
            Mapper.Map(pathDoc, bookForAuthorFromRepo);
        ...
        {
            book.Links.Add(
                new LinkDto(_urlHelper.Link("GetBookForAuthor", new { id = book.Id }),
                "self",
                "GET"));
